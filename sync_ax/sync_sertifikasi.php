...
while ($row = mssql_fetch_object($querymaster)) {	
	$q_sync = "REPLACE INTO sms_ax_view_custmastersertifikasi VALUES('".$row->NoReg."',DATE(STR_TO_DATE('".$row->TglRegistrasi."','%M %d %Y %H:%i')),'".$row->TipeSertifikasi."',DATE(STR_TO_DATE('".$row->ExpireDate."','%M %d %Y %H:%i')),'".$row->RecId."');";        	
